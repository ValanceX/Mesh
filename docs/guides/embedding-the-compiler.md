...
```toml
[dependencies]
mesh-compiler = { git = "https://github.com/ValanceX/Mesh", tag = "v0.5.0" }
mesh-syntax   = { git = "https://github.com/ValanceX/Mesh", tag = "v0.5.0" }
mesh-semantic = { git = "https://github.com/ValanceX/Mesh", tag = "v0.5.0" }
# Only to check against a component manifest, or to use the analysis as data:
mesh-manifest = { git = "https://github.com/ValanceX/Mesh", tag = "v0.5.0" }
mesh-analysis = { git = "https://github.com/ValanceX/Mesh", tag = "v0.5.0" }
```
