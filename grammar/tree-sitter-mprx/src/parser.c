...
enum ts_symbol_identifiers {
  ...
  sym_source_file = 10,
  sym_element = 11,
  sym_self_closing_element = 12,
  sym_container_element = 13,
  sym_attribute = 14,
  sym_string = 15,
  aux_sym_self_closing_element_repeat1 = 16,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_container_element] = STATE(12),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [5] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_self_closing_element_repeat1, 2, 0, 0),
  [7] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_self_closing_element_repeat1, 2, 0, 0), SHIFT_REPEAT(13),
  [10] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [12] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [14] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [16] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [18] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [20] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3, 0, 4),
  [22] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 3, 0, 2),
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 2, 0, 0),
  ...
  [40] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 1, 0, 0),
  [42] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_self_closing_element, 3, 0, 1),
  ...
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_self_closing_element, 4, 0, 1),
  ...
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_container_element, 6, 0, 1),
  ...
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_container_element, 7, 0, 3),
  [76] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_container_element, 7, 0, 1),
  [80] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_container_element, 8, 0, 5),
};
